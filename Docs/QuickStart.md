...
## 4. Or skip all of that with Quick Match
...
Quick Match searches, joins the best session (good ping, fuller rooms first), and hosts a new session if nothing is found. Use `Is Easy Session Host` to check which outcome you got.
